...
values ('2025-06-12 09:00:00', null, 0, 'Empprestimo de livros', 1, 1, 1);
...
case when evento.tipo_evento = 0 then 'emprestimo' when evento.tipo_evento = 1 then 'devolução'  else '' end as tipo_evento, usuario.nome from evento
